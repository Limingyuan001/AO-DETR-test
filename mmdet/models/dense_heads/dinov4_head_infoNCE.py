...
class InfoNCE(nn.Module):
    ...
    def forward(self, embedded, class_num, temperature=0.07):
        ...
        if self.metric == 'l2':
            ...
            logits = torch.cat([positive_logits_diag.view(2, k, n, 1), all_logits.view(2, k, n, -1)],
                               dim=-1)  # [batch_size, k, n, k*n+1]
...
class DINOHeadv4(DeformableDETRHead):
    ...
    def loss(self, hidden_states: Tensor, references: List[Tensor],
        ...
        info_loss = InfoNCE_loss(queries_batch, class_num, temperature=1)
