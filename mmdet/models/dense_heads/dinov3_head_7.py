...
# TODO dinov3head6 在dinov2_head6的基础上，引入dinov3head4中的对比学习，进一步将query聚类。4/13/2024
import json
import os
...
class DINOHeadv3(DINOHead):
    ...
    def loss(self, hidden_states: Tensor, references: List[Tensor],
        ...
        queries_batch = torch.cat([hidden_states[i, :, -60:, :] for i in indices_list], dim=0)
        ...
        intra_loss = sim_max_loss(queries_batch, class_num)*0.001
