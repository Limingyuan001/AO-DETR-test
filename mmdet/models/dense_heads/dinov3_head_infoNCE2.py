...
class InfoNCE(nn.Module):
    ...
    def forward(self, embedded, class_num, temperature=0.07):
        ...
        if self.metric == 'l2':
            ...
            # todo infoNCE loss 在mmcl中不需要使用cls
            ...
            positive_logits = torch.einsum('bknj,bkNj->bknN', content_queries, content_queries)  # [2, k, n, n]
            ...
            all_logits = torch.einsum('bik,bjk->bij', content_queries_flat, content_queries_flat)  # [batch_size, k*n, k*n]
            ...
            labels = torch.zeros(2, k, n).to(content_queries.device)  # 正样本对标签为 0
...
class DINOHeadv3(DeformableDETRHead):
    ...
    def loss(self, hidden_states: Tensor, references: List[Tensor],
        ...
        info_loss = InfoNCE_loss(queries_batch, class_num, temperature=1)  # temperature=1 为n-pair loss， =1/0.07 为infoNCE
