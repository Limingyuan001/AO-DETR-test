...
class DINO(DeformableDETR):
    ...
    def pre_decoder(
        ...
        topk_coords_unact = topk_coords_unact.detach()  # top100的预测坐标预测结果0-1
        ...
        if self.training: # TODO 搞清楚这里训练和测试过程中reference_points的区别，看懂dn_query_generator的理论基础
            ...
            query = torch.cat([dn_label_query, query], dim=1) # todo 注意这里后面的才是无噪音的query，别搞错了19/3/2024
    ...
    def forward_decoder(self,
                        ...
                        ,**kwargs # TODO 将dinov.py中的def forward_decoder加入**kwargs接口
                        ) -> Dict:
        ...
        inter_states, references = self.decoder(
            ...
            cls_head= self.bbox_head.cls_branches  # todo t-SNE同时降维分类器用2024/10/12
            , **kwargs  # TODO 传入**kwargs接口内容
        )
