...
class HungarianAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        assigned_gt_inds[matched_row_inds] = matched_col_inds + 1 # assigned_gt_inds得到的是真值个体索引，对assinged gt序列加1是因为这里面的内容0为背景，TODO 后续不知到应该怎么立即用，所有真值顺序加一
        assigned_labels[matched_row_inds] = gt_labels[matched_col_inds]  # assigned_labels得到的是真值的类别索引
        return AssignResult(
            num_gts=num_gts,
