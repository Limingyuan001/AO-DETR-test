_base_ = [
    '../_base_/datasets/hixray_detection.py', '../_base_/default_runtime.py'
]
# -------------------------------------------------#
# 记录一下更改内容
# 第一，改上面的数据集
...
model = dict(
    ...
    num_queries=320,  # num_matching_queries 900
    ...
    # test_cfg=dict(max_per_img=50))  # 50是q16和q40
    # test_cfg = dict(max_per_img=300))  # 300 是q320 r50
    test_cfg = dict(max_per_img=100))  # 100 是q320 swin
