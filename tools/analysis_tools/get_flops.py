...
def parse_args():
    ...
    # dino r50 320,320 keep redio= false Flops: 26.891G Params: 58.376M
    # parser.add_argument('--config',default=r'D:\Projects\DINO_mmdet3\mmdetection\configs\dino\dino-4scale_r50_8xb2-12e_pixray_mine68.py', help='train config file path')

    # parser.add_argument('--config',default=r'D:\Projects\DINO_mmdet3\mmdetection\configs\dino\dino-5scale_swin-l_8xb2-12e_coco_mine68.py', help='train config file path')

    parser.add_argument('--config',default=r'D:\Projects\DINO_mmdet3\mmdetection\configs\deformable_detr\deformable-detr_r50_16xb2-50e_pixray.py', help='train config file path')
