...
def parse_args():
    ...
    # todo 这个代码还是跑不了，可以用test过程的1000张图片要的时间计算
     # parser.add_argument('--config',default=r'D:\Projects\DINO_mmdet3\mmdetection\configs\dino\dino-4scale_r50_8xb2-12e_pixray_mine68.py', help='test config file path')
    parser.add_argument('--config',default=r'D:\Projects\DINO_mmdet3\mmdetection\configs\faster_rcnn\faster-rcnn_r50_fpn_1x_coco.py', help='test config file path')

    parser.add_argument('--checkpoint',default=r'E:\D2E\Projects\DINO_mmdet3\checkpoint\dino\r50_pixray\106\best_coco_bbox_mAP_epoch_12.pth', help='checkpoint file')
    parser.add_argument(
        '--task',
